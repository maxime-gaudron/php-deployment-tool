...
use QaSystem\CoreBundle\Form\ProjectType;
...
class ProjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QaSystemCoreBundle:Project')->findAll();
     ...
     * @Method("POST")
     * @Template("QaSystemCoreBundle:Project:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("QaSystemCoreBundle:Project:edit.html.twig")
     */
